...
class replay_memory:
    def __init__(self, capacity, input_shape):
        ...
        self.reward_memory = np.zeros(capacity, dtype='float32')
        self.terminal_memory = np.zeros(capacity, dtype='bool')

    def add_entry(self, state1, action, state2, reward, terminal):
    ...
    def sample_batch(self, size):
        ...
        return (states1, actions, states2, rewards, terminals)